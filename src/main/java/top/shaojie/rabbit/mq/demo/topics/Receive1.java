package top.shaojie.rabbit.mq.demo.topics;
 ...
 * @Description: topics 主题模式 接受信息 【消费者1】
 */
public class Receive1 {

    private static final String QUEUE = "test_exchange_topic_1";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        String routingKey2 = "good.update";
        /**
         * queue 队列名称
